      ...
      >
        ...
        >
          ...
          <ul>
            ...
            >
              Eco cotton, recyled polyester, recycled lurex, mercerized cotton,
              elirex, filling yarn
            </li>
          </ul>
          <h2
        ...
        <div class="mt-[30px] col-span-2 row-span-3">
          <img
            class="w-full"
            src="/images/soft-2021/soft-2021-2.jpg"
            alt="Soft! 2021 #2"
            width="640"
            height="960"
          />
    ...
    <div class="container mx-auto px-[17.5px] md:px-[30px] lg:px-[55px]">
      ...
      >
        <div class="lg:mt-[125px] lg:ml-[118px]">
          <img
            class="w-full"
            src="/images/soft-2021/soft-2021-3.jpg"
            alt="Soft! 2021 #3"
            width="640"
            height="960"
            loading="lazy"
        ...
        <div class="mt-[15px] lg:mt-0">
          <img
            class="w-full"
            src="/images/soft-2021/soft-2021-4.jpg"
            alt="Soft! 2021 #4"
            width="640"
            height="960"
            loading="lazy"
        ...
        <div class="mt-[15px] lg:mt-0">
          <img
            class="w-full"
            src="/images/soft-2021/soft-2021-5.jpg"
            alt="Soft! 2021 #5"
            width="640"
            height="960"
            loading="lazy"
        ...
        <div class="mt-[15px] lg:mt-[50px] lg:mr-[118px]">
          <img
            class="w-full"
            src="/images/soft-2021/soft-2021-6.jpg"
            alt="Soft! 2021 #6"
            width="640"
            height="960"
            loading="lazy"
        ...
        <div class="mt-[15px] lg:mt-[125px] lg:ml-[118px]">
          <img
            class="w-full"
            src="/images/soft-2021/soft-2021-7.jpg"
            alt="Soft! 2021 #7"
            width="640"
            height="960"
            loading="lazy"
        ...
        <div class="mt-[15px] lg:mt-0">
          <img
            class="w-full"
            src="/images/soft-2021/soft-2021-8.jpg"
            alt="Soft! 2021 #8"
            width="640"
            height="960"
            loading="lazy"
        ...
        <div class="mt-[15px] lg:mt-0">
          <img
            class="w-full"
            src="/images/soft-2021/soft-2021-9.jpg"
            alt="Soft! 2021 #9"
            width="640"
            height="960"
            loading="lazy"
